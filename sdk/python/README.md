...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `symbiosis` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-symbiosis
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-symbiosis/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-symbiosis_darwin_amd64_v1
│   └── pulumi-resource-symbiosis
├── pulumi-symbiosis_darwin_arm64
│   └── pulumi-resource-symbiosis
├── pulumi-symbiosis_linux_amd64_v1
│   └── pulumi-resource-symbiosis
├── pulumi-symbiosis_linux_arm64
│   └── pulumi-resource-symbiosis
├── pulumi-symbiosis_windows_amd64_v1
│   └── pulumi-resource-symbiosis.exe
└── pulumi-symbiosis_windows_arm64
    └── pulumi-resource-symbiosis.exe
```
