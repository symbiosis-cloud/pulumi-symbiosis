...
namespace Symbiosis.Pulumi.Symbiosis
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/symbiosis-cloud";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Symbiosis.Pulumi.Symbiosis.version.txt");
    ...
    internal sealed class SymbiosisResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SymbiosisResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
